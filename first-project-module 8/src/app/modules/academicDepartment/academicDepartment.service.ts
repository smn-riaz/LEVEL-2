...
export const AcademicDepartmentServices = {
    createAcademicDepartmentIntoDB, getSingleAcademicDepartmentFromDB, updateAcademicDepartmentFromDB,getAllAcademicFacultiesFromDB: getAllAcademicDepartmentsFromDB
}